// src/main.js
/**
 * Main entry point for EliteCryptoSuite application
 */
...
class EliteCryptoSuite {
    /**
     * Create a new EliteCryptoSuite instance
...
module.exports = EliteCryptoSuite;
...
if (require.main === module) {
    ...
    const app = new EliteCryptoSuite({
        input: args.input,
        output: args.output,
